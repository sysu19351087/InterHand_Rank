...
class CLIFF(nn.Module):
    ...
    def __init__(self, smpl_mean_params, img_feat_num=2048):
        ...
        lmean_params = left=pickle.load(open(osp.join(smpl_mean_params + 'MANO_LEFT.pkl'), 'rb'), encoding='iso-8859-1')
        rmean_params = left=pickle.load(open(osp.join(smpl_mean_params + 'MANO_RIGHT.pkl'), 'rb'), encoding='iso-8859-1')
